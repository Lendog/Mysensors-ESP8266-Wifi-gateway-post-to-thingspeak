 ...
 *
 * Make sure to fill in your ssid and WiFi password below for ssid & pass.  (also add thingspeak key further down)
 * 
 * Big thanks to Yveaux and nikil511 for there original code
 */
...
{ 
  ...
  //Changed below line - added ESP so didn't have to moddifly gatewayutil.h
...
//   }
  ...
  if (message.type == V_TEMP) {   //V_TEMP, // S_TEMP. Temperature S_TEMP, S_HEATER, S_HVAC
    thingspeak(message.sensor, message.getString(convBuf),"#####");  // add thingspeak key
  }
